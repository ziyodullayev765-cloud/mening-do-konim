...
# Mini App'ning o'z manzili. Railway'da deploy qilgandan keyin "Settings > Networking
# > Generate Domain" orqali olingan havolani shu yerga yozasiz, masalan:
# WEBAPP_URL = "https://mening-dokonim.up.railway.app/"
WEBAPP_URL = os.environ.get("WEBAPP_URL", "https://PLACEHOLDER.up.railway.app/")
...
def main():
    ...
    # Admin paneldagi "oddiy" tugmalar (matn kiritishni talab qilmaydigan)
    app.add_handler(CallbackQueryHandler(admin_delete_menu, pattern="^adm_delete$"))
    app.add_handler(CallbackQueryHandler(admin_editprice_entry, pattern="^adm_editprice$"))
    app.add_handler(CallbackQueryHandler(admin_instant_actions, pattern="^(adm_list|adm_back|delp_)"))
